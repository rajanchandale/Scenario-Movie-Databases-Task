...
def sign_up():
     ...
     while x == False:
          ...
          #Gender Check
          wholeGenderCheck = False
          if gender == "M" or gender == "F" or gender == "O":
               x = True
               wholeGenderCheck = True
               print("wholeGenderCheck True")
          ...
          halfInterestCheck1 = False
          halfInterestCheck2 = False

          if len(interests) == 3:
               x = True
               contTo_R_Check = True
               halfInterestCheck1 = True
               print("halfInterestCheck1 True")
     ...
     if userCheck == True and wholePwCheck == True and wholeGenderCheck == True and halfInterestCheck1 == True and halfInterestCheck2 == True:
